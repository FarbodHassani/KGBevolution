...
$MathematicaToClass = 
	...
	(* A's *)
	A0[]             -> {"A0", "pvecback[pba->index_bg_A0_smg]"},
	A1[]             -> {"A1", "pvecback[pba->index_bg_A1_smg]"},
	A2[]             -> {"A2", "pvecback[pba->index_bg_A2_smg]"},
	A3[]             -> {"A3", "pvecback[pba->index_bg_A3_smg]"},
	A4[]             -> {"A4", "pvecback[pba->index_bg_A4_smg]"},
	A5[]             -> {"A5", "pvecback[pba->index_bg_A5_smg]"},
	A6[]             -> {"A6", "pvecback[pba->index_bg_A6_smg]"},
	A7[]             -> {"A7", "pvecback[pba->index_bg_A7_smg]"},
	A8[]             -> {"A8", "pvecback[pba->index_bg_A8_smg]"},
	A9[]             -> {"A9", "pvecback[pba->index_bg_A9_smg]"},
	A10[]            -> {"A10", "pvecback[pba->index_bg_A10_smg]"},
	A11[]            -> {"A11", "pvecback[pba->index_bg_A11_smg]"},
	A12[]            -> {"A12", "pvecback[pba->index_bg_A12_smg]"},
	A13[]            -> {"A13", "pvecback[pba->index_bg_A13_smg]"},
	A14[]            -> {"A14", "pvecback[pba->index_bg_A14_smg]"},
	A15[]            -> {"A15", "pvecback[pba->index_bg_A15_smg]"},
	A16[]            -> {"A16", "pvecback[pba->index_bg_A16_smg]"},
	(* B's *)
	...
	(* C's *)
	C0[]             -> {"C0", "pvecback[pba->index_bg_C0_smg]"},
	C1[]             -> {"C1", "pvecback[pba->index_bg_C1_smg]"},
	C2[]             -> {"C2", "pvecback[pba->index_bg_C2_smg]"},
	C3[]             -> {"C3", "pvecback[pba->index_bg_C3_smg]"},
	C4[]             -> {"C4", "pvecback[pba->index_bg_C4_smg]"},
	C5[]             -> {"C5", "pvecback[pba->index_bg_C5_smg]"},
	C6[]             -> {"C6", "pvecback[pba->index_bg_C6_smg]"},
	C7[]             -> {"C7", "pvecback[pba->index_bg_C7_smg]"},
	C8[]             -> {"C8", "pvecback[pba->index_bg_C8_smg]"},
	C9[]             -> {"C9", "pvecback[pba->index_bg_C9_smg]"},
	C10[]            -> {"C10", "pvecback[pba->index_bg_C10_smg]"},
	C11[]            -> {"C11", "pvecback[pba->index_bg_C11_smg]"},
	C12[]            -> {"C12", "pvecback[pba->index_bg_C12_smg]"},
	C13[]            -> {"C13", "pvecback[pba->index_bg_C13_smg]"},
	C14[]            -> {"C14", "pvecback[pba->index_bg_C14_smg]"},
	C15[]            -> {"C15", "pvecback[pba->index_bg_C15_smg]"},
	C16[]            -> {"C16", "pvecback[pba->index_bg_C16_smg]"}
	|>;
...
ClassToMathematica::usage = "ClassToMathematica[text, var] looks for var in text, \
trying to identify possible definitions for var. Then it writes the definition \
as a Mathematica expression. var is treated as a regular expression, which means \
that all the special characters should be properly escaped.";
...
ParseEquation[text_, var_,pos_:1]:=Module[{list,str},
	str = "";
...
ClassToMathematica[text_, var_, pos_:1, OptionsPattern[]]:=Module[
	...
	(* Parse Equation *)
	str = ParseEquation[text,var,pos];
	...
	str = "("<>StringReplace[str,{"="->")==(", ";"->")"}];
	str = StringReplace[str, "pow("~~x_~~","~~n__~~")"/;StringMatchQ[n,RegularExpression["-*[0-9]+"]]:>"("<>x<>"^("<>n<>"))"];
