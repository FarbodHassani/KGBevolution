...
struct perturbs
{
  ...
  short has_source_alpha;         /**< do we need source for metric fluctuation eta? */
  short has_source_alpha_prime;   /**< do we need source for metric fluctuation eta'? */
  ...
  int index_tp_alpha;       /**< index value for metric fluctuation alpha */
  int index_tp_alpha_prime; /**< index value for metric fluctuation alpha' */
...
/* perturbed recombination */
  ...
  int index_pt_alpha;       /**< synchronous gauge metric perturbation eta*/
